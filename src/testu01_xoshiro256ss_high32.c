 ...
 *
 * testu01_xoshiro256ss_high32 - Copyright(C) 2026 Matteo Zapparoli (zapparoli.matteo@gmail.com)
 * 
 * SPDX-License-Identifier: Apache-2.0
 *
 * Compile: gcc -std=c99 -Wall -O3 -o testu01_xoshiro256ss_high32 testu01_xoshiro256ss_high32.c -ltestu01 -lm
 *
 * Sintax:
 *  testu01_xoshiro256ss_high32 [(small | crush | big) <seed> <seed> <seed> <seed>]
 *
 * No args prints help
 *
 */
...
unsigned int xoshiro256ssHigh32(void) 
{
...
int main(int argc, char *argv[])
{
	...
	unif01_Gen *gen = unif01_CreateExternGenBits("xoshiro256ssHigh32", xoshiro256ssHigh32);

	printf("=== TestU01 - Generator: xoshiro256ssHigh32 ===\n");
	for(int i = 0; i < 4; i++) {
