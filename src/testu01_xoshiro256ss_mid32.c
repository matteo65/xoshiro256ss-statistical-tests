/*
 * testu01_xoshiro256ss_mid32.c
 *
 * Execute TestU01 SmallCrush, Crush and BigCrush on xoshiro256ss (middle 32 bits)
 *
 * xoshiro256** pseudorandom number generator - Copyright(C) D.Blackman & S.Vigna (vigna@acm.org)
 *
 * testu01_xoshiro256ss_mid32 - Copyright(C) 2026 Matteo Zapparoli (zapparoli.matteo@gmail.com)
 * 
 * SPDX-License-Identifier: Apache-2.0
 *
 * Compile: gcc -std=c99 -Wall -O3 -o testu01_xoshiro256ss_mid32 testu01_xoshiro256ss_mid32.c -ltestu01 -lm
 *
 * Sintax:
 *  testu01_xoshiro256ss_mid32 [(small | crush | big) <seed> <seed> <seed> <seed>]
 *
 * No args prints help
 *
 */
...
unsigned int xoshiro256ssMid32(void) 
{
...
void usage(void)
{
	printf("testu01_xoshiro256ss_mid32 - Run TestU01 SmallCrush, Crush and BigCrush on xoshiro256** (middle 32 bits)\n\n");
	printf("Usage: testu01_xoshiro256ss_mid32 [(small | crush | big) <seed> <seed> <seed> <seed>]\n\n");
...
int main(int argc, char *argv[])
{
	...
	unif01_Gen *gen = unif01_CreateExternGenBits("xoshiro256ssMid32", xoshiro256ssMid32);
